...
class TicketsController < ApplicationController
  ...
  def destroy
    ...
    # permission check
    ticket = Ticket.find(params[:id])
    ticket_permission(ticket, 'destroy')
  ...
  def ticket_merge
    ...
    # permission check
    ticket_permission(ticket_master, 'all')
    ...
    # permission check
    ticket_permission(ticket_slave, 'all')
  ...
  def ticket_all(ticket)
    ...
    # get attributes to update
    attributes_to_change = Ticket::ScreenOptions.attributes_to_change(current_user: current_user, ticket: ticket)
